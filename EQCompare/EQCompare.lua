...
function EQCompare:OnInitialize()
	...
	self:RegisterChatCommand({ "/eqcomparecl", "/eqccl" }, self:options())
	self:RegisterChatCommand({ "/eqcompare", "/eqc"}, function() waterfall:Open('EQCompare') end)
	waterfall:Register('EQCompare', 'aceOptions', self:options(), 'title','EQCompare 1.5','colorR', 0.2, 'colorG', 0.6, 'colorB', 0.2) 
